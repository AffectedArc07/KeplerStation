...
/datum/component/spooky/proc/spectral_attack(datum/source, mob/living/carbon/C, mob/user)
	...
	if(ishuman(C))
		...
		C.Jitter(35)
		C.stuttering = 20
		if((!istype(H.dna.species, /datum/species/skeleton)) && (!istype(H.dna.species, /datum/species/golem)) && (!istype(H.dna.species, /datum/species/ipc)) && (!istype(H.dna.species, /datum/species/jelly)))
...
/datum/component/spooky/proc/spectral_change(mob/living/carbon/human/H, mob/user)
	if((H.getStaminaLoss() > 95) && (!istype(H.dna.species, /datum/species/skeleton)) && (!istype(H.dna.species, /datum/species/golem)) && (!istype(H.dna.species, /datum/species/ipc)) && (!istype(H.dna.species, /datum/species/jelly)))
		H.Knockdown(20)
